...
const products = [
  {
    ...
    fallbackImage:'assets/products/greenmax.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/mimax.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/blumax.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/nutrimax.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/kordymax.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/fleximax.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/machoman.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/yekaterina.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/lamor.jpg',
  ...
  },
  {
    ...
    fallbackImage:'assets/products/mi-serum.jpg',
...
const testimonials = [
  {
    ru:{text:'Принимала GreenMAX и NutriMAX. Ожирение печени 3 степени стало 1 степени, похудела за неделю на 3 кг, отёки ушли — чувствую себя легко!', name:'Айгуль'},
    ky:{text:'GreenMAX жана NutriMAX ичтим. Боордун майлануусу 3-даражадан 1-даражага түштү, бир жумада 3 кг арыктадым, шишиктер кетти — өзүмдү жеңил сезем!', name:'Айгүл'}
  },
  {
    ru:{text:'За 9 дней приёма GreenMAX, MiMAX и BluMAX ушёл вес 1,5 кг, отёк с лица ушёл. Боль в ноге после операции прошла, суставы перестали болеть.', name:'Бакыт'},
    ky:{text:'GreenMAX, MiMAX жана BluMAX ичкен 9 күндө 1,5 кг салмак кетти, беттеги шишик басылды. Операциядан кийинки бут оорусу басылды, муундар ооруба калды.', name:'Бакыт'}
  },
  {
    ru:{text:'У ребёнка бронхиальная астма — плюс к MiMAX на ночь GreenMAX. За четыре года первый раз без одышки!', name:'Назира'},
    ky:{text:'Балама бронхиалдык астма коюлган — түнкүсүн MiMAX менен GreenMAX бердим. Төрт жылдан бери биринчи жолу дем кыстыгуусуз!', name:'Назира'}
  }
];
